...
public class TeamPanel extends Panel
{
	...
	public TeamPanel(ComponentContainer parent, PixelRect rect, Team team)
	{
		super(parent, rect);
	...
	public void update(LinkedList<LobbyPlayer> players)
	{
		...
		getComponents().clear();
		getComponents().add(teamButton = new Button(this, new PixelRect(20, 20, 100, 30), "Team " + team.getName())
		{		
		...
		for (LobbyPlayer player : players)
		{
			...
			{
				getComponents().add(new PlayerPanel(this, new PixelRect(getX() + 5 + i*65, 55, 60, 60), player));
				i++;
			}
		}
